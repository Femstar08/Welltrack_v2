...
class HealthRepositoryImpl {
  ...
  Future<int> saveHealthMetrics(List<HealthMetricEntity> metrics) async {
    ...
    try {
      ...
      _logger.error('Error saving health metrics: $e');
      rethrow;
    }
  }
  ...
  Future<void> deduplicateMetrics(String userId, String profileId) async {
    try {
      ...
      _logger.debug('Deduplication completed: $response');
    } catch (e) {
      // If the stored procedure doesn't exist, we skip deduplication
      // The DB trigger handles most cases
      _logger.warning('Deduplication skipped or failed: $e');
    }
  }
  ...
  Future<List<HealthMetricEntity>> getMetricsSince(
    ...
    try {
      ...
      _logger.error('Error fetching metrics since $since: $e');
      return [];
    }
  }
  ...
  Future<List<HealthMetricEntity>> getMetricsForDateRange(
    ...
    try {
      ...
      _logger.error('Error fetching metrics for date range: $e');
      return [];
    }
  }
  ...
  Future<List<HealthMetricEntity>> getMetricsByType(
    ...
    try {
      ...
      _logger.error('Error fetching metrics by type: $e');
      return [];
    }
  }
  ...
  Future<int> getMetricCount(
    ...
    try {
      ...
      _logger.error('Error getting metric count: $e');
      return 0;
    }
  }
  ...
  Future<({DateTime? first, DateTime? last})?> getDataTimeRange(
    ...
    try {
      ...
      _logger.error('Error getting data time range: $e');
      return null;
    }
  }
  ...
  Future<double?> getAverageMetricValue(
    ...
    try {
      ...
      _logger.error('Error calculating average metric value: $e');
      return null;
    }
  }
  ...
  Future<double?> getMedianMetricValue(
    ...
    try {
      ...
      _logger.error('Error calculating median metric value: $e');
      return null;
    }
  }
  ...
  Future<int> deleteMetricsForProfile(String profileId) async {
    try {
      ...
      _logger.error('Error deleting metrics for profile: $e');
      return 0;
    }
  }
  ...
  Future<void> updateProcessingStatus(
    ...
    try {
      ...
      _logger.error('Error updating processing status: $e');
      rethrow;
    }
  }
  ...
  Future<void> updateValidationStatus(
    ...
    try {
      ...
      _logger.error('Error updating validation status: $e');
      rethrow;
    }
  }
}
